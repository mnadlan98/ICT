    ...
    <div class="parallax-content baner-content" id="home">
        <div class="container">
            ...
            <div class="first-content">
                ...
                <span><img src="../images/logo.jpg" style="position: absolute; left: 30%; right: 49.22%; top: 22.22%; bottom: 50.65%; border-radius:20px; width:280px; height:140px;"></span> 
                <h5  style="position: absolute; left: 43%; right: 49.22%; top: 34%; bottom: 50.65%; border-radius:20px; width:280px; height:140px;"><strong>oleh</strong></h5>
                <span><img src="../images/telkom-logo.png" style="position: absolute; left: 55%; right: 39.27%; top: 33%; bottom: 44.07%; width:160px; height:90px;"></span>

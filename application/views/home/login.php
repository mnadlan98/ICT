  ...
  <h5 style="font-weight: bolder; color: black; padding-left: 9em; margin-top: 6em; "><strong style="border-bottom: 3px solid red; font-size:24px; ">Masuk</strong></h5></br></br>
    ...
    <form method="post">
      <div class="form-group">
        ...
        <input type="text" class="form-control  " id="username_or_email" name="username_or_email" placeholder="Email Sekolah" style="padding-left:3em;">
      ...
      <div class="form-group">
        <a href="#" style="color: light-blue; text-decoration: none; padding-left:1vh; font-family: Lato;"><small><u>Lupa Password?</u></small></a>
      </div>
      <div class="row">

							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td width="250">
											<a onclick="editModal('<?php echo site_url('admin/overview/edit_term/'.$s->id_syarat) ?>','<?php echo $s->kalimat?>','Edit Syarat dan Ketentuan','syarat')"
											 href="#!" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('admin/overview/delete_term/'.$s->id_syarat) ?>')"
